...
cur.execute(
    ''' SELECT "Display Id", "Type", "Found By", "State", "Team Name", "Portfolio Item Display Id", "Created By Name", "Core?", "Closed Date", "Closed By Name", "Release Name" FROM V1_tickets WHERE "Found By" LIKE "%IM1_______%" ''')
result = cur.fetchall()
sql.commit()
print()
print('Begin V1-Defect search')
print()
for i in range(len(result)):
    ...
    if len(result[cycle][2]) > 10:
        ...
        if carve[-10:-7] == 'IM1':      # put an insert for the first IM here
            ...
            cur.execute(''' INSERT INTO V1_tickets("Name", "Display Id", "Type", "Found By", "State", "Team Name", "Portfolio Item Display Id", "Created By Name", "Core?", "Closed Date", "Closed By Name", "Release Name")
...
# 'IM1\d+'
# SQL Search statement: SELECT "Display Id","Found By" FROM V1_tickets WHERE ("Found By" LIKE "IM1_______" or "Found By" LIKE "IM1_______ & IM1_______"  or "Found By" LIKE "IM1_______, IM1_______" or  "Found By" LIKE "IM1_______ and IM1_______")
